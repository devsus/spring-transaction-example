...
public class ProductService {
	...
	// Transaction A:
	//@Transactional(isolation = Isolation.READ_UNCOMMITTED) // Means we can read uncommitted data 
	@Transactional(isolation = Isolation.SERIALIZABLE) // It will force run one by one parallel transaction
	public void updateStock(int productId, int stock) throws InterruptedException {
		...
		//TransactionAspectSupport.currentTransactionStatus().setRollbackOnly();//explicit
		// rollback
